#-*- coding: utf-8 -*-
'''If CTSwap.live found @nobitanobi_420 html.run.py'''
''' html.run.py = HTML'''
#HTML = -*-coding: utf-8 -*- nobi


A = "pk"
#Edit pk to your tron wallet private key
T = 'bot'
#Edit Bot to Your Bot Token Generated by @botfather
W = "Welcome"
#Edit Welcome to Welcome Message user show when he use command /start
b = "nobitanobi_420"
#Edit nobitanobi_420 to Your username with small letter don't add @
u = "Testro8bot"
#Edit Testro8bot to Your Bot Username don't add @
...
def start(update, context):
    ...
    update.effective_message.reply_text(W)
